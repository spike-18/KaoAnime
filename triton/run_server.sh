...
# e.g. MODEL_ONNX=NOT-cuda.onnx). The HTTP / gRPC / metrics ports default to
...
MODEL_ONNX="${MODEL_ONNX:?set MODEL_ONNX to the ONNX file to serve, e.g. MODEL_ONNX=NOT-cuda.onnx}"
